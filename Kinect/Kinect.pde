...
void draw() {
  ...
  for (int i = 0; i < skeletonArray.size(); i++) {
    ...
    if (skeleton.isTracked()) {
      ...
      stroke(255);
      strokeWeight(3);
      rect(rightHandX, height/3, 300, 300);

      fill(255);
      stroke(255);
      strokeWeight(3);
      rect(leftHandX, height/3, 300, 300);
      ...
      if (abs(rightHandX-leftHandX) < 400)
      {
        ...
        stroke(255, 0, 0);
        strokeWeight(3);
        rect((rightHandX+leftHandX)/2+100, height/3 + 10*sin(.02*a), a+100*cos(0.009*a+10), sin(-.075*a+3)*300);

        fill(0, 255, 0);
        stroke(0, 255, 0);
        strokeWeight(3);
        rect((rightHandX+leftHandX)/2, height/3, 300*sin(0.09*a+100), a+sin(.0065*a+22)*100);

        fill(0, 0, 255);
        stroke(0, 0, 255);
        strokeWeight(3);
        rect((rightHandX+leftHandX)/2-100, height/3, 200*cos(0.09*a+10), a+sin(.0095*a+33)*200);
      }
